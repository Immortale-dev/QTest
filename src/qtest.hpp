...
#define DESCRIBE(a, ...) Q_TEST__DESCRIBE(a, Q_TEST__LAMBDA(__VA_ARGS__), QTEST_TEST_PARAM_ID, __FILE__)
#define DESCRIBE_ONLY(a, ...) Q_TEST__DESCRIBE(a, Q_TEST__LAMBDA(__VA_ARGS__), QTEST_ONLY_PARAM_ID, __FILE__)
#define DESCRIBE_SKIP(a, ...) Q_TEST__DESCRIBE(a, Q_TEST__LAMBDA(__VA_ARGS__), QTEST_SKIP_PARAM_ID, __FILE__)
