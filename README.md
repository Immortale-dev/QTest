...
#### EXPECT (expression)
This macro used to resolve the test cases. It is required one parameter to be passed. You can send any **expression** you want to proceed with in your test case, this macro will return **QTestExpect** class instance, which has different methods to for resolving data. You can find all available methods in [QTestExpect class](#QTestExpect) section.
